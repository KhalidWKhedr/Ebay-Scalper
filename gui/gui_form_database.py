...
class Ui_form_Database(object):
    def setupUi(self, form_Database):
        ...
        self.frame_URI = QFrame(self.frame_Database)
        self.frame_URI.setObjectName(u"frame_URI")
        self.frame_URI.setGeometry(QRect(0, 247, 1101, 141))
        self.frame_URI.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_URI.setFrameShadow(QFrame.Shadow.Raised)
        self.widget = QWidget(self.frame_URI)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(6, 6, 1091, 131))
        ...
        self.gridLayout_7.addWidget(self.button_TestConnection, 1, 0, 1, 1)
        ...
        self.frame_AUTH.setGeometry(QRect(890, 0, 211, 221))
        ...
        self.frame_MONGODB.setGeometry(QRect(0, 0, 431, 251))
        ...
        self.frame_SSH.setGeometry(QRect(450, 0, 421, 181))
